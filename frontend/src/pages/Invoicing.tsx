        ...
        {isModalOpen && (
          <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg w-full max-w-lg p-6 relative">
              ...
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Create New Invoice</h2>
              <form className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Client Name</label>
                  <input type="text" className="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Amount</label>
                  <input type="number" className="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Due Date</label>
                  <input type="date" className="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white" />
                </div>
            ...
            <div className="max-h-96 overflow-y-auto">
              <table className="w-full">
                <thead className="bg-gray-50 dark:bg-gray-700 sticky top-0 z-10 border-b border-gray-200 dark:border-gray-700">
                  <tr>
                    <th className="text-left py-4 px-6 font-semibold text-gray-900 dark:text-white min-w-[120px]">
                      Invoice #
                    </th>
                    <th className="text-left py-4 px-6 font-semibold text-gray-900 dark:text-white min-w-[120px]">
                      Invoice Date
                    ...
                    <th className="text-left py-4 px-6 font-semibold text-gray-900 dark:text-white min-w-[100px]">
                      Approved?
                    </th>
                    <th className="text-left py-4 px-6 font-semibold text-gray-900 dark:text-white min-w-[180px]">
                      Client Name
                    </th>
                    <th className="text-left py-4 px-6 font-semibold text-gray-900 dark:text-white min-w-[100px]">
                      Period
                    ...
                    <th className="text-left py-4 px-6 font-semibold text-gray-900 dark:text-white min-w-[150px]">
                      Notes
                    </th>
                    <th className="text-left py-4 px-6 font-semibold text-gray-900 dark:text-white min-w-[80px]">
                      Action
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {paginatedInvoices.map((invoice) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-6">
                        <span className="text-gray-700 dark:text-gray-300">
                          {new Date(invoice.sendDate).toLocaleDateString()}
                        </span>
                      </td>
                      <td className="py-4 px-6">
                        <span
                      ...
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center">
                            {invoice.customerName.includes("Inc.") ||
                            invoice.customerName.includes("Ltd.") ? (
                      ...
                      <td className="py-4 px-6">
                        <span className="font-semibold text-red-600 dark:text-red-400">
                          {formatCurrency(invoice.cardCharge)}
                        </span>
                      </td>
                      <td className="py-4 px-6">
